...
function reset() {
    ...
    document.getElementById('playerMana').innerHTML = "Mana: "+playerMana+"/200";
    document.getElementById('enemyHP').innerHTML = "HP: "+enemyHP+"/1000";
...
function start() {
    ...
    setTimeout(function(){
    if(tutorialCount==0){
        alert("Defeat ganondorf to win, hyrule depends of you, remember that your special attacks can evade enemy shields");
      }
    }, 200);
       
}
    
    function updateButton(){ //permite que los botones recuperen las propiedades de disabled
...
function player(event){ //logica jugador
...
function enemy(){
   ...
   if(enemyShildCount<2){
    ...
    if(playerShild==0){ //normal attack
        playerHP= playerHP-100;
        document.getElementById('playerHP').innerHTML = "HP: "+playerHP+"/900";
        document.getElementById('enemyLastAttack').innerHTML = "Last Action: "+"Normal Attack";
        ...
        document.getElementById('enemyLastAttack').innerHTML = "Last Action: "+" Attack miss";
    }  
    ...
    document.getElementById('enemyLastAttack').innerHTML = "Last Action: "+"Shild";
    showPicture("img/shild.png",'attackGanondorf');
     noteSound = document.getElementById('shildWAV');
        ...
        if(enemyAttack>=0.5){ //revenge
            playerHP= playerHP-200;
            document.getElementById('playerHP').innerHTML ="HP: "+playerHP+"/900";
            document.getElementById('enemyLastAttack').innerHTML = "Last Action: "+"Revenge";
         ...
         noteSound = document.getElementById('manaAttackWAV');
            ...
            if(playerShild==0){
                ...
                document.getElementById('enemyLastAttack').innerHTML = "Last Action: "+"Revenge Attack miss";
            }
        }
    }
...
{   
    ...
    let image = new Image(); 
    image.src = pic;
    const SceneDiv = document.querySelector("."+select);
